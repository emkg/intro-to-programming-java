/*
 * I want to make this repeat as many times as the user wants to play. I also want it
 * to slow down so the user can have a more authentic experience. As is, an optional 
 * roll again only occurs once. 
 */


import java.util.Scanner;

public class CrapsOne 
{
